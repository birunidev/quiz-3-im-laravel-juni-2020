...
Route::get('/articles/{id}', 'ArticleController@show'); // menampilkan detail item dengan id 
Route::get('/articles/{id}/edit', 'ArticleController@edit'); // menampilkan form untuk edit item
